...
const HeroSection = () => {
  return (
    <section className="relative pt-24 pb-16 md:pt-28 md:pb-24 lg:pt-36 lg:pb-32 flex items-center justify-center overflow-hidden bg-[#020202]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-20 items-center">
          ...
          <div className="text-left">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-white/5 border border-white/10 text-[10px] md:text-xs font-bold text-gray-300 uppercase tracking-widest mb-6 md:mb-8"
            >
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6 md:mb-8 tracking-tight text-white"
            >
            ...
            <motion.p 
              ...
              className="text-gray-400 text-sm sm:text-base md:text-xl max-w-2xl leading-relaxed mb-8 md:mb-10"
            >
          ...
          <div className="relative h-[350px] md:h-[400px] w-full flex mt-8 lg:mt-0 items-center justify-center perspective-1000 scale-[0.85] sm:scale-90 lg:scale-100">
...
const PhilosophySection = () => {
  return (
    <section className="py-16 md:py-24 relative overflow-hidden bg-[#030408] border-y border-white/5">
      <div className="max-w-6xl mx-auto px-5 md:px-6">
        <div className="text-center mb-12 md:mb-20">
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-6 text-white">The Fazamous <span className="text-blue-500">Architecture</span></h2>
          <p className="text-gray-400 text-sm md:text-base max-w-2xl mx-auto">How we structure our approach to solving the most complex industry problems.</p>
        </div>

        {/* Custom Animated Diagram */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-4 relative h-auto md:h-[400px]">
          {/* Node 1 */}
          <motion.div 
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="w-full md:w-64 h-auto md:h-64 bg-[#0a0f1c] border border-white/10 rounded-2xl md:rounded-3xl p-5 md:p-6 flex flex-col items-center justify-center text-center relative group hover:border-blue-500/50 transition-colors z-10 shadow-xl"
          >
            <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl md:rounded-3xl" />
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-blue-500/10 flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform shadow-[0_0_20px_rgba(59,130,246,0.2)]">
              <Database className="w-6 h-6 md:w-8 md:h-8 text-blue-400" />
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-1 md:mb-2 relative z-10">Data Ingestion</h3>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full md:w-72 h-auto md:h-72 bg-[#05070e] border border-purple-500/30 rounded-3xl md:rounded-full py-6 px-5 md:p-8 flex flex-col items-center justify-center text-center relative group hover:border-purple-500 transition-colors z-10 shadow-[0_0_40px_rgba(168,85,247,0.15)] overflow-hidden"
          >
            ...
            <div className="absolute inset-[2px] bg-[#05070e] rounded-3xl md:rounded-full z-0"></div>
            
            <div className="relative z-10 w-16 h-16 md:w-20 md:h-20 rounded-full bg-purple-500/10 flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform shadow-[0_0_30px_rgba(168,85,247,0.3)]">
              <BrainCircuit className="w-8 h-8 md:w-10 md:h-10 text-purple-400" />
            </div>
            <h3 className="relative z-10 text-lg md:text-xl font-bold text-white mb-1 md:mb-2">AI Processing</h3>
          ...
          >
            <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-2xl md:rounded-3xl" />
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-blue-500/10 flex items-center justify-center mb-2 md:mb-4 group-hover:scale-110 transition-transform shadow-[0_0_20px_rgba(59,130,246,0.2)]">
              <Zap className="w-6 h-6 md:w-8 h-8 text-blue-400" />
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-1 md:mb-2 relative z-10">Actionable Output</h3>
...
const CoreValuesSection = () => {
  return (
    <section className="py-16 md:py-24 max-w-6xl mx-auto px-5 md:px-6">
      <div className="text-left mb-8 md:mb-12">
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-white">What Drives Us</h2>
        <p className="text-gray-400 text-sm md:text-lg">The principles that dictate every line of code we write.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-auto md:auto-rows-[200px]">
        ...
        >
          ...
          <div className="relative z-10 bg-[#060810] h-full w-full rounded-[23px] p-5 md:p-8 overflow-hidden flex flex-col justify-end">
            ...
            <Target className="w-7 h-7 md:w-10 md:h-10 text-blue-400 mb-3 md:mb-6 relative z-10" />
            <h3 className="text-xl md:text-2xl font-bold text-white mb-2 md:mb-3 relative z-10">Precision Engineering</h3>
            <p className="text-[12.5px] md:text-sm text-gray-400 max-w-sm leading-relaxed relative z-10">
        ...
        >
          ...
          <div className="relative z-10 bg-[#060810] h-full w-full rounded-[23px] p-5 md:p-6 overflow-hidden flex flex-col justify-end">
            {/* Animated Diagram */}
            <div className="absolute top-5 right-5 md:top-6 md:right-6 w-12 h-12 md:w-16 md:h-16 pointer-events-none z-0 opacity-40 md:opacity-100">
            ...
            <Shield className="w-6 h-6 md:w-8 md:h-8 text-purple-400 mb-3 md:mb-4 relative z-10" />
            <h3 className="text-lg md:text-xl font-bold text-white mb-1.5 md:mb-2 relative z-10">Data Security</h3>
            <p className="text-[12px] md:text-xs text-gray-400 leading-relaxed relative z-10">
        ...
        >
          ...
          <div className="relative z-10 bg-[#060810] h-full w-full rounded-[23px] p-5 md:p-6 overflow-hidden flex flex-col justify-end">
            {/* Animated Diagram */}
            <div className="absolute top-5 right-5 md:top-6 md:right-6 w-12 h-12 md:w-16 md:h-16 pointer-events-none z-0 flex gap-1 opacity-40 md:opacity-100">
               {[1,2,3].map(i => (
            ...
            <Users className="w-6 h-6 md:w-8 md:h-8 text-blue-400 mb-3 md:mb-4 relative z-10" />
            <h3 className="text-lg md:text-xl font-bold text-white mb-1.5 md:mb-2 relative z-10">Human Centric</h3>
            <p className="text-[12px] md:text-xs text-gray-400 leading-relaxed relative z-10">
          ...
          <div className="relative z-10 bg-[#060810] h-full w-full rounded-[23px] p-5 md:p-6 overflow-hidden flex flex-col justify-end">
            ...
            <div className="absolute top-5 right-5 md:top-6 md:right-6 w-12 h-12 md:w-16 md:h-16 pointer-events-none z-0 opacity-40 md:opacity-100">
               <motion.div animate={{ rotate: 360 }} transition={{ duration: 10, repeat: Infinity, ease: "linear" }} className="w-full h-full rounded-full border border-white/10 flex items-center justify-center">
                  <Globe className="w-6 h-6 md:w-8 md:h-8 text-white/20" />
               </motion.div>
            </div>
            
            <Globe className="w-6 h-6 md:w-8 md:h-8 text-white mb-3 md:mb-4 relative z-10" />
            <h3 className="text-lg md:text-xl font-bold text-white mb-1.5 md:mb-2 relative z-10">Global Scalability</h3>
            <p className="text-[12px] md:text-xs text-gray-400 leading-relaxed relative z-10">
        ...
        >
          ...
          <div className="relative z-10 bg-[#060810] h-full w-full rounded-[23px] p-5 md:p-6 overflow-hidden flex flex-col justify-end">
            ...
            <div className="absolute top-5 right-5 md:top-6 md:right-6 w-12 h-12 md:w-16 md:h-16 pointer-events-none z-0 opacity-40 md:opacity-100">
               ...
               <Lightbulb className="w-12 h-12 md:w-16 md:h-16 text-yellow-500/20 absolute" />
            </div>

            <Lightbulb className="w-6 h-6 md:w-8 md:h-8 text-yellow-400 mb-3 md:mb-4 relative z-10" />
            <h3 className="text-lg md:text-xl font-bold text-white mb-1.5 md:mb-2 relative z-10">Continuous Innovation</h3>
            <p className="text-[12px] md:text-xs text-gray-400 leading-relaxed relative z-10">
...
const TeamSection = () => {
  return (
    <section className="py-16 md:py-24 max-w-6xl mx-auto px-0 md:px-6 overflow-hidden">
      <div className="text-center mb-10 md:mb-16 px-5 md:px-0">
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-white">Our Specialized Expertise</h2>
        <p className="text-gray-400 text-sm md:text-lg">A synergy of brilliant human minds and fine-tuned AI agents.</p>
      </div>
      ...
      <div className="relative overflow-hidden w-full max-w-full">
         ...
         <motion.div 
           ...
           className="flex w-max gap-4 md:gap-6 px-4 md:px-6"
         >
           {[
             ...
             <div key={i} className="w-[220px] md:w-[280px] flex-shrink-0 bg-[#050505] border border-white/10 rounded-2xl p-4 md:p-6 flex flex-col items-center text-center group hover:bg-[#0a0a0a] transition-colors relative overflow-hidden">
                ...
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-[#0a0f1c] border border-white/5 flex items-center justify-center mb-4 md:mb-6 group-hover:border-blue-500/30 transition-colors z-10">
                  <member.icon className="w-5 h-5 md:w-6 md:h-6 text-gray-400 group-hover:text-blue-400 transition-colors" />
                </div>
                <h4 className="text-white font-bold text-base md:text-lg mb-1 relative z-10">{member.name}</h4>
                <p className="text-blue-500 text-[10px] md:text-xs font-semibold uppercase tracking-wider mb-2 md:mb-3 relative z-10">{member.role}</p>
                <p className="text-gray-500 text-[11px] md:text-xs leading-relaxed relative z-10">{member.desc}</p>
             </div>
           ))}
         </motion.div>
      </div>
