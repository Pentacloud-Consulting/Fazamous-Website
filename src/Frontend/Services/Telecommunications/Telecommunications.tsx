...
export default function Telecommunications() {
  return (
    <div className="min-h-screen bg-[#03050a] text-white selection:bg-blue-500/30 font-sans overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-12 lg:pt-28 lg:pb-16 max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative z-10">
            ...
            <h1 className="text-5xl lg:text-[64px] font-bold leading-[1.1] mb-6 tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <button className="w-full sm:w-auto bg-white text-black px-6 py-3 rounded-xl text-sm font-bold hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
                Book a Free Consultation <ArrowRight className="w-4 h-4" />
              </button>
              <button className="w-full sm:w-auto bg-transparent border border-white/20 text-white px-6 py-3 rounded-xl text-sm font-bold hover:bg-white/5 transition-colors flex items-center justify-center gap-2">
          ...
          <div className="relative h-[600px] w-full flex items-center justify-center lg:mt-0 mt-12 overflow-visible">
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-16 w-full relative z-10 max-w-2xl mx-auto">
               <div className="bg-[#05050a]/60 backdrop-blur-md border border-white/10 p-5 rounded-2xl transform lg:-translate-y-12 shadow-2xl relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="text-[10px] text-gray-300 font-medium mb-1">Network Performance</div>
                    <div className="text-3xl font-bold text-white mb-1">98.6%</div>
                    <div className="text-[10px] text-gray-200 font-medium drop-shadow-md">Uptime Achieved</div>
                  </div>
               ...
               <div className="bg-[#05050a]/60 backdrop-blur-md border border-white/10 p-5 rounded-2xl transform lg:-translate-y-4 shadow-2xl relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="text-[10px] text-gray-300 font-medium mb-1">Operational Efficiency</div>
                    <div className="text-3xl font-bold text-white mb-1">-35%</div>
                    <div className="text-[10px] text-gray-200 font-medium drop-shadow-md">Cost Reduction</div>
                  </div>
                  <div className="absolute bottom-0 left-0 w-full h-16 pointer-events-none">
                     <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
                       <defs>
               ...
               <div className="bg-[#05050a]/60 backdrop-blur-md border border-white/10 p-5 rounded-2xl transform lg:translate-y-6 shadow-2xl relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="text-[10px] text-gray-300 font-medium mb-1">Customer Satisfaction</div>
                    <div className="text-3xl font-bold text-white mb-1">90%</div>
                    <div className="text-[10px] text-gray-200 font-medium drop-shadow-md">CSAT Score</div>
                  </div>
                  <div className="absolute bottom-0 left-0 w-full h-16 pointer-events-none">
                     <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
                       <defs>
               ...
               <div className="bg-[#05050a]/60 backdrop-blur-md border border-white/10 p-5 rounded-2xl transform lg:translate-y-16 shadow-2xl relative overflow-hidden group">
                  <div className="relative z-10">
                    <div className="text-[10px] text-gray-300 font-medium mb-1">AI Driven Insights</div>
                    <div className="text-3xl font-bold text-white mb-1">24/7</div>
                    <div className="text-[10px] text-gray-200 font-medium drop-shadow-md">Real-time Monitoring</div>
                  </div>
                  <div className="absolute bottom-0 left-0 w-full h-16 pointer-events-none">
                     <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
                       <defs>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            ...
            <div key={i} className="group relative rounded-2xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(59,130,246,0.3)] overflow-hidden cursor-pointer h-full p-[1px]">
              ...
              <div className="relative z-10 bg-[#060810] h-full w-full rounded-[15px] p-6 flex flex-col overflow-hidden">
                ...
                <div className="absolute top-5 right-5 text-gray-500 opacity-20 group-hover:opacity-60 group-hover:rotate-90 transition-all duration-500 pointer-events-none">
                  <Plus className="w-3.5 h-3.5" />
                </div>

                <div className="relative z-10 flex flex-col h-full">
                  <div className="w-12 h-12 rounded-xl bg-[#0a0f1c] border border-white/5 flex items-center justify-center mb-5 group-hover:bg-blue-500/10 group-hover:border-blue-500/20 transition-all duration-500 shadow-inner shadow-white/5">
                    <sol.icon className="w-5 h-5 text-blue-400 group-hover:scale-110 transition-transform duration-500" />
                  </div>
                  <h3 className="text-[15px] font-bold mb-4 text-white group-hover:text-blue-400 transition-colors duration-300">{sol.title}</h3>
                  <ul className="space-y-3 mb-6 flex-1">
                    {sol.points.map((pt, j) => (
                      <li key={j} className="text-gray-400 text-[12px] flex items-start gap-2.5 leading-relaxed">
                        <span className="w-1 h-1 rounded-full bg-gray-600 mt-[7px] flex-shrink-0 group-hover:bg-blue-400 transition-colors duration-300"></span>
                        <span>{pt}</span>
                      </li>
                    ))}
                  </ul>
                  <div className="mt-auto flex justify-end">
                    <ArrowRight className="w-4 h-4 text-gray-600 group-hover:text-blue-400 group-hover:translate-x-1 transition-all duration-300" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col justify-center h-full">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-6 w-fit">
                Industry Challenges
              </div>
              <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6">
                Solving Real Challenges In <br/> <span className="text-blue-500">Telecommunications.</span>
              </h2>
              <p className="text-gray-400 text-sm leading-relaxed max-w-md border-l-2 border-blue-500/30 pl-5 py-2 mb-6">
              ...
              <div className="relative w-full h-[200px] bg-[#05050a]/50 rounded-3xl border border-white/5 overflow-hidden flex items-center justify-center group shadow-2xl shadow-black/50">
                {/* Grid Background */}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="group relative bg-[#0a0f1c]/30 backdrop-blur-sm border border-white/5 p-6 rounded-2xl hover:bg-white/[0.02] hover:border-white/10 transition-all duration-500 overflow-hidden flex gap-5 items-start cursor-pointer hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br from-[#0a0f1c] to-[#03050a] border border-white/5 flex items-center justify-center flex-shrink-0 relative z-10 shadow-inner shadow-white/5 ${challenge.hoverBorder} ${challenge.hoverBg} transition-all duration-500`}>
                    <challenge.icon className={`w-5 h-5 text-gray-500 ${challenge.hoverText} group-hover:scale-110 transition-all duration-500`} />
                  </div>
                  <div className="relative z-10 mt-0.5">
                    <h4 className={`text-white text-[15px] font-bold mb-1.5 ${challenge.hoverText} transition-colors duration-300`}>{challenge.title}</h4>
                    <p className="text-gray-400 text-[13px] leading-relaxed group-hover:text-gray-300 transition-colors duration-300">{challenge.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-20 border-y border-white/5 bg-[#03050a]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-[1fr_2fr] gap-12 items-center">
            <div className="pr-8 lg:border-r border-white/5 h-full flex flex-col justify-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed border-l-2 border-white/10 pl-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12 pl-0 lg:pl-8">
              {[
                { val: "35%", label: "Reduced\nOp Costs", icon: Activity },
                { val: "50%", label: "Improved\nRetention", icon: Users },
                { val: "98%", label: "Network\nAvailability", icon: Network },
                { val: "30%+", label: "Increase\nin Revenue", icon: TrendingUp },
              ].map((stat, i) => (
                <div key={i} className="relative group pl-5 lg:pl-6">
                  ...
                  <stat.icon className="w-5 h-5 text-gray-500 mb-5 group-hover:text-blue-400 transition-colors duration-500 group-hover:translate-x-1 transition-transform" />
                  
                  <div className="text-4xl lg:text-[40px] font-black text-white tracking-tighter mb-2 group-hover:text-blue-400 transition-colors duration-500 group-hover:translate-x-1 transition-transform">
                    {stat.val}
                  </div>
                  <div className="text-gray-400 text-[13px] font-medium leading-relaxed group-hover:text-gray-300 transition-colors duration-500 group-hover:translate-x-1 transition-transform whitespace-pre-line">
                    {stat.label}
                  </div>
                </div>
              ))}
      ...
      <section className="py-16 bg-[#03050a] relative overflow-hidden border-y border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-10">
            <div className="text-blue-500 text-[10px] font-bold uppercase tracking-widest mb-3 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span> Use Cases
            </div>
          ...
          {/* Bento Grid */}
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 md:auto-rows-[200px]">
            {/* Item 1: AI Customer Assistant (Wide) */}
            <div className="md:col-span-2 md:row-span-1 group relative bg-[#0a0f1c]/80 backdrop-blur-md border border-white/5 rounded-3xl p-5 lg:p-6 overflow-hidden hover:border-blue-500/40 transition-all duration-500">
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[9px] font-bold text-blue-300 tracking-wider uppercase">
                    Impact: 40% Cost Reduction
                  </div>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">AI Customer Assistant</h3>
                <p className="text-gray-400 text-[13px] max-w-md">24/7 AI assistants resolving complex customer queries across voice, chat and messaging with human-like accuracy.</p>
              </div>
            </div>

            {/* Item 2: Predictive Maintenance (Normal) */}
            <div className="md:col-span-1 md:row-span-1 group relative bg-[#0a0f1c]/80 backdrop-blur-md border border-white/5 rounded-3xl p-5 overflow-hidden hover:border-purple-500/40 transition-all duration-500 flex flex-col">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-base font-bold text-white mb-2">Predictive Maintenance</h3>
                <p className="text-gray-400 text-[12px] mb-3 flex-1">AI predicts network failures before they happen to ensure uptime.</p>
                <div className="text-purple-400 text-[9px] font-bold tracking-widest uppercase mt-auto">
                  60% fewer downtimes
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-1 md:row-span-2 group relative bg-gradient-to-b from-[#0a0f1c] to-[#03050a] border border-white/5 rounded-3xl p-5 overflow-hidden hover:border-emerald-500/40 transition-all duration-500 flex flex-col">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-lg font-bold text-white mb-3">Churn Prediction Engine</h3>
                <p className="text-gray-400 text-[13px] mb-4 flex-1">Identify at-risk customers early by analyzing behavior patterns and take proactive, personalized retention actions automatically.</p>
                
                <div className="bg-[#05050a]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-4 mt-auto text-center group-hover:border-emerald-500/30 transition-colors">
                  <div className="text-emerald-400 text-2xl font-black mb-1">30%</div>
                  <div className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">Better Retention</div>
                </div>
              </div>
            </div>

            {/* Item 4: Fraud Detection (Normal) */}
            <div className="md:col-span-1 md:row-span-1 group relative bg-[#0a0f1c]/80 backdrop-blur-md border border-white/5 rounded-3xl p-5 overflow-hidden hover:border-red-500/40 transition-all duration-500 flex flex-col">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-base font-bold text-white mb-2">Fraud Detection</h3>
                <p className="text-gray-400 text-[12px] mb-3 flex-1">Real-time detection of SIM boxing and revenue leakages.</p>
                <div className="text-red-400 text-[9px] font-bold tracking-widest uppercase mt-auto">
                  $10M+ saved
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 md:row-span-1 group relative bg-[#0a0f1c]/80 backdrop-blur-md border border-white/5 rounded-3xl p-5 lg:p-6 overflow-hidden hover:border-blue-500/40 transition-all duration-500 flex justify-between items-center">
              ...
              <div className="relative z-10 max-w-sm">
                <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-4">
                  <Network className="w-5 h-5 text-gray-300 group-hover:text-blue-400 group-hover:scale-110 transition-all" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Network Capacity Planning</h3>
                <p className="text-gray-400 text-[13px]">AI accurately forecasts traffic demand spikes to optimize network capacity planning and resource allocation.</p>
              </div>
              
              <div className="relative z-10 hidden sm:flex flex-col items-center justify-center px-4">
                <div className="w-20 h-20 rounded-full border-4 border-blue-500/20 border-t-blue-500 flex items-center justify-center shadow-[0_0_20px_rgba(59,130,246,0.15)] group-hover:rotate-12 transition-transform duration-700">
                  <span className="text-xl font-black text-white group-hover:-rotate-12 transition-transform duration-700">25%</span>
                </div>
                <div className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mt-3 text-center">
