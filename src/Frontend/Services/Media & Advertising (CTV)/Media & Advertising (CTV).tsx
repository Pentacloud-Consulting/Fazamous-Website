...
const HeroSection = () => {
  return (
    <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden pt-24 bg-[#050401]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden opacity-20 pointer-events-none flex flex-col justify-center gap-12">
        {[...Array(5)].map((_, i) => (
          <motion.div 
            key={i}
            animate={{ x: ["-100%", "100%"] }}
          ...
          >
            {[...Array(10)].map((_, j) => (
              <div 
                key={j} 
                className={`h-4 rounded-full bg-gradient-to-r from-transparent via-[#eab308]/30 to-transparent backdrop-blur-sm`}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-left">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#eab308]/10 border border-[#eab308]/30 text-[10px] md:text-xs font-bold text-[#eab308] uppercase tracking-widest mb-8 shadow-[0_0_20px_rgba(234,179,8,0.2)]"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-6xl lg:text-[80px] font-bold leading-[1.1] mb-8 tracking-tight text-white"
          >
            Hyper-Targeted.<br />
        ...
        <div className="relative w-full h-[400px] md:h-[500px] perspective-1000 hidden lg:block">
           ...
           <motion.div
             ...
             className="absolute top-[15%] right-[-5%] bg-[#0a0f0d]/95 backdrop-blur-xl border border-emerald-500/30 p-3 rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.5)] flex items-center gap-3 z-20"
           >
              <Target className="w-6 h-6 text-emerald-400" />
              <div>
                <div className="text-xs font-bold text-emerald-400">Conversion</div>
                <div className="text-[10px] text-gray-400">Attributed</div>
              </div>
           </motion.div>
...
const MetricsTickerSection = () => {
  return (
    <section className="py-10 bg-gradient-to-r from-[#050401] via-[#141005] to-[#050401] border-y border-[#eab308]/10 overflow-hidden">
        ...
        >
          {[...Array(2)].map((_, idx) => (
            <React.Fragment key={idx}>
              <div className="flex items-center gap-3"><TrendingUp className="w-6 h-6 text-[#eab308]" /><span className="text-2xl font-black text-white">4.2x ROI LIFT</span></div>
              <div className="flex items-center gap-3"><Eye className="w-6 h-6 text-[#facc15]" /><span className="text-2xl font-black text-white">100% VIEWABILITY</span></div>
              <div className="flex items-center gap-3"><Target className="w-6 h-6 text-[#fef08a]" /><span className="text-2xl font-black text-white">REAL-TIME ATTRIBUTION</span></div>
              <div className="flex items-center gap-3"><Shield className="w-6 h-6 text-yellow-500" /><span className="text-2xl font-black text-white">ZERO AD FRAUD</span></div>
            </React.Fragment>
          ))}
        </motion.div>
      </div>
...
const AttributionEngineSection = () => {
  return (
    <section className="py-16 md:py-20 relative bg-[#0a0802] overflow-hidden">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Omnichannel <span className="text-[#eab308]">Attribution</span></h2>
          <p className="text-gray-400 max-w-xl mx-auto text-sm md:text-base">Connect the dots across screens to prove exactly which CTV ad drove the mobile app install or web purchase.</p>
        </div>

        <div className="relative w-full h-[400px] bg-[#0c0a03] rounded-3xl border border-white/5 overflow-hidden shadow-2xl">
          
          {/* Connective Paths */}
          <svg viewBox="0 0 1000 400" preserveAspectRatio="none" className="absolute inset-0 w-full h-full pointer-events-none hidden md:block">
            {/* Top to Center */}
          ...
          {/* Ad Exposures Header */}
          <h3 className="absolute top-6 left-[5%] text-white/40 text-[10px] font-mono uppercase tracking-widest z-10 hidden md:block">Ad Exposures</h3>
  ...
  return (
    <section className="py-16 md:py-20 max-w-5xl mx-auto px-6">
      <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold mb-3 text-white">Platform <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#eab308] to-[#facc15]">Capabilities</span></h2>
          <p className="text-gray-400 text-sm md:text-base max-w-xl">Harness the full power of the CTV ecosystem with our suite of advanced streaming analytics tools.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {cases.map((card, i) => (
          <motion.div 
            ...
            className={`group relative rounded-2xl overflow-hidden p-[1.5px] cursor-pointer ${
          ...
          >
            ...
            {/* Inner Card Content */}
            <div className="relative z-10 bg-[#0a0802] group-hover:bg-[#120f04] transition-colors duration-500 rounded-[calc(1rem-1.5px)] h-full p-6 flex flex-col justify-between border border-white/5">
              
              <div>
                <div className="w-10 h-10 rounded-xl bg-[#141005] border border-[#eab308]/20 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-500 shadow-inner">
                  <card.icon className="w-5 h-5 text-[#eab308]" />
                </div>
                
                <h3 className="text-lg md:text-xl font-bold text-white mb-2 group-hover:text-[#facc15] transition-colors">
                  {card.title}
                </h3>
              ...
              {(i === 0 || i === 3) && (
                 <div className="mt-6 pt-4 border-t border-white/5 flex gap-2 overflow-hidden opacity-50 group-hover:opacity-100 transition-opacity">
                    <motion.div 
                      animate={{ x: ["-100%", "200%"] }} 
...
const AudienceBuilderSection = () => {
  return (
    <section className="py-20 md:py-24 relative bg-[#050401] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16 relative z-10">
        ...
        <div className="lg:w-1/2">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#eab308]/10 border border-[#eab308]/30 text-[10px] font-mono text-[#eab308] mb-6 uppercase tracking-widest">
            <Users className="w-3 h-3" />
            Audience Graph
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight">Dynamic <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#eab308] to-[#facc15]">Segmentation</span></h2>
          ...
          <div className="flex flex-col gap-4">
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-[#0a0802] border border-white/5 hover:border-[#eab308]/30 hover:bg-[#120e05] transition-all duration-300 cursor-pointer">
              <div className="w-10 h-10 rounded-full bg-[#eab308]/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
                <Play className="w-5 h-5 text-[#facc15]" />
              </div>
              <div>
                <h4 className="text-white font-bold text-base mb-1 group-hover:text-[#facc15] transition-colors">Content Affinity Targeting</h4>
                <p className="text-sm text-gray-400">Target users who binge-watched specific genres in the last 7 days.</p>
              </div>
            </div>
            <div className="group flex items-start gap-4 p-5 rounded-2xl bg-[#0a0802] border border-white/5 hover:border-[#eab308]/30 hover:bg-[#120e05] transition-all duration-300 cursor-pointer">
              <div className="w-10 h-10 rounded-full bg-[#eab308]/10 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              ...
              <div>
                <h4 className="text-white font-bold text-base mb-1 group-hover:text-[#facc15] transition-colors">Household Syncing</h4>
                <p className="text-sm text-gray-400">Map connected TVs to mobile devices on the same IP network.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:w-1/2 w-full">
          ...
          >
            ...
            <div className="w-full bg-[#0a0802] border border-white/5 rounded-2xl overflow-hidden flex flex-col relative z-10">
              ...
              {/* Header (MacOS Style) */}
              <div className="h-12 border-b border-white/10 flex items-center px-4 bg-[#141005] gap-2">
                <div className="flex gap-1.5 mr-2">
                  <div className="w-3 h-3 rounded-full bg-red-500/80" />
                  <div className="w-3 h-3 rounded-full bg-yellow-500/80" />
                  <div className="w-3 h-3 rounded-full bg-green-500/80" />
                </div>
                <div className="flex items-center gap-2 bg-black/40 px-3 py-1 rounded-md text-xs font-mono text-gray-400 border border-white/5 mx-auto">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <span className="px-4 py-1.5 bg-[#1a1406] border border-white/10 rounded-full text-xs text-gray-300 flex items-center gap-2 shadow-inner">
                    Geo: <span className="text-white font-bold">North America</span>
                  </span>
                  <span className="px-4 py-1.5 bg-[#eab308]/10 border border-[#eab308]/30 rounded-full text-xs text-[#facc15] flex items-center gap-2 shadow-[0_0_10px_rgba(234,179,8,0.1)]">
...
const AdFraudSection = () => {
  return (
    <section className="py-16 md:py-20 relative overflow-hidden bg-[#050401]">
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        
        {/* Header */}
        <div className="text-center max-w-2xl mx-auto mb-10 md:mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/30 text-[10px] font-mono text-red-500 mb-4 uppercase tracking-widest shadow-[0_0_15px_rgba(239,68,68,0.2)]">
        ...
        {/* Visualizer */}
        <div className="relative w-full h-[250px] md:h-[300px] bg-[#0a0802] border border-white/5 rounded-3xl overflow-hidden flex items-center justify-center shadow-2xl">
          {/* Ambient Glows */}
          ...
          {/* Connective Lines */}
          <div className="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none hidden md:block">
          ...
          <div className="absolute inset-0 flex items-center justify-between px-[5%] md:px-[15%]">
            ...
            <div className="relative flex flex-col items-center">
              <div className="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-[#141005] border border-white/10 flex items-center justify-center z-10 shadow-lg">
                <Globe className="w-5 h-5 md:w-7 md:h-7 text-gray-500" />
              </div>
              <div className="mt-3 text-[9px] md:text-[10px] font-mono text-gray-500 text-center uppercase tracking-widest hidden md:block">Global<br/>Traffic</div>
            </div>

            {/* Shield Node (Filter) */}
            <div className="relative flex flex-col items-center group">
              <div className="absolute inset-0 bg-red-500/20 blur-xl rounded-full group-hover:bg-red-500/30 transition-colors" />
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#1a0505] border-2 border-red-500/50 flex items-center justify-center z-10 shadow-[0_0_30px_rgba(239,68,68,0.3)] relative">
              ...
              <div className="mt-3 text-[9px] md:text-[10px] font-mono text-red-500 text-center uppercase tracking-widest font-bold hidden md:block">Fraud<br/>Engine</div>
            </div>

            {/* Destination Node (Clean) */}
            <div className="relative flex flex-col items-center">
              <div className="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-[#05140a] border border-emerald-500/20 flex items-center justify-center z-10 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
                <CheckCircle className="w-5 h-5 md:w-7 md:h-7 text-emerald-500" />
              </div>
              <div className="mt-3 text-[9px] md:text-[10px] font-mono text-emerald-500 text-center uppercase tracking-widest hidden md:block">Verified<br/>Impressions</div>
            </div>
          </div>
