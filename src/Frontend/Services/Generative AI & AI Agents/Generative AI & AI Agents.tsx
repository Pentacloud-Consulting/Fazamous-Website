...
const HeroSection = () => {
  return (
    <section className="relative min-h-[95vh] flex items-center overflow-hidden pt-40 lg:pt-32 bg-[#010606]">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 w-full pb-20 lg:pb-0">
        
        {/* Left Side: Information */}
        <div className="w-full lg:w-1/2 text-left pt-16 lg:pt-12">
          <motion.div 
            initial={{ opacity: 0, y: -20 }} 
            animate={{ opacity: 1, y: 0 }} 
            transition={{ duration: 0.8 }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#14b8a6]/10 border border-[#14b8a6]/30 text-xs font-bold text-[#14b8a6] uppercase tracking-widest mb-8 shadow-[0_0_20px_rgba(20,184,166,0.2)] mt-8 md:mt-0"
          >
        ...
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end relative h-[350px] md:h-[450px] lg:h-[500px] items-center">
...
const RAGArchitectureSection = () => {
  return (
    <section className="py-16 md:py-20 relative bg-[#020909] overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative w-full h-auto min-h-[600px] md:min-h-[400px] md:h-[400px] bg-[#040e0e] rounded-3xl border border-white/5 p-6 md:p-8 flex flex-col md:block items-center justify-center overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          
          {/* Mobile Layout (Stacked) */}
          <div className="md:hidden flex flex-col items-center gap-6 z-10 w-full py-8">
...
const CapabilitiesSection = () => {
  const cases = [
    { 
      ...
      delay: 0,
      Diagram: () => (
        <div className="relative w-full h-20 bg-gradient-to-b from-[#081818] to-[#040e0e] border border-white/5 rounded-xl overflow-hidden group-hover:border-[#14b8a6]/30 transition-colors mb-6 flex items-center justify-center">
    ...
    { 
      ...
      delay: 0.3,
      Diagram: () => (
        <div className="relative w-full h-20 bg-gradient-to-b from-[#081818] to-[#040e0e] border border-white/5 rounded-xl overflow-hidden group-hover:border-[#14b8a6]/30 transition-colors mb-6 flex flex-col items-center justify-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {cases.map((card, i) => (
          <motion.div 
            ...
            className="group relative rounded-2xl overflow-hidden p-[1px] transition-transform duration-500 hover:-translate-y-1 h-full"
          >
            ...
            {/* Inner Content Box */}
            <div className="relative w-full h-full bg-[#040e0e] rounded-[15px] p-5 md:p-6 overflow-hidden z-10 transition-colors duration-500 group-hover:bg-[#061414] flex flex-col">
               {/* Background Glow */}
               ...
               <h3 className="text-xl md:text-2xl font-bold text-white mb-3 group-hover:text-[#2dd4bf] transition-colors">
                 {card.title}
               </h3>
...
const AgentReasoningSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 relative bg-[#010606] overflow-hidden">
      {/* Top Title Area */}
      <div className="max-w-4xl mx-auto text-center px-6 mb-12 md:mb-16 relative z-10">
      ...
      {/* Bento Grid */}
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-4 relative z-10">
        
        {/* The Terminal - Spans 2 Columns */}
        <div className="lg:col-span-2 bg-[#040e0e] border border-white/5 rounded-3xl p-5 md:px-8 md:pt-8 md:pb-6 relative overflow-hidden group shadow-2xl flex flex-col justify-between hover:border-[#14b8a6]/30 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(20,184,166,0.15)] transition-all duration-500">
           {/* Background Glow */}
           ...
           <div className="flex items-center gap-4 mb-5">
             <div className="w-14 h-14 rounded-xl bg-[#14b8a6]/10 border border-[#14b8a6]/20 flex items-center justify-center shadow-[0_0_15px_rgba(20,184,166,0.15)]">
               <Cpu className="w-7 h-7 text-[#14b8a6]" />
             </div>
             <div>
               <h3 className="text-white font-bold text-xl">Autonomous Reasoning Core</h3>
               <div className="text-sm text-[#14b8a6] font-mono mt-1">system.execute(multi_agent_pipeline)</div>
             </div>
           </div>

           {/* Redesigned Terminal UI (Grid based) */}
           <div className="bg-[#081313] border border-white/5 rounded-2xl overflow-hidden font-mono mt-2 flex-1 flex flex-col shadow-2xl">
              {/* Header */}
              <div className="h-10 border-b border-white/5 flex items-center px-4 gap-2 bg-[#020606]">
              ...
              <div className="p-4 md:p-5 flex flex-col gap-4">
                 {/* User Prompt */}
                 <div className="bg-[#102424] border border-[#14b8a6]/20 rounded-xl p-3 md:p-4 text-gray-300 text-sm shadow-inner relative overflow-hidden">
                   <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#14b8a6]" />
                   <span className="text-[#14b8a6] font-bold mr-2">{">"} USER_PROMPT:</span>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className={`p-3 rounded-xl border transition-all duration-500 ${step >= 0 ? 'bg-[#14b8a6]/10 border-[#14b8a6]/30' : 'bg-white/5 border-white/5 opacity-50'}`}>
                       <div className="text-[#2dd4bf] text-xs font-bold mb-1 flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${step === 0 ? 'bg-[#2dd4bf] animate-pulse shadow-[0_0_8px_#2dd4bf]' : 'bg-[#2dd4bf]/50'}`} /> Planner Agent</div>
                       <div className="text-[10px] text-gray-400">Breaking down task into 3 sequential sub-tasks.</div>
                    </div>
                    <div className={`p-3 rounded-xl border transition-all duration-500 ${step >= 1 ? 'bg-yellow-500/10 border-yellow-500/30' : 'bg-white/5 border-white/5 opacity-50'}`}>
                       <div className="text-yellow-500 text-xs font-bold mb-1 flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${step === 1 ? 'bg-yellow-500 animate-pulse shadow-[0_0_8px_yellow]' : 'bg-yellow-500/50'}`} /> Data Executor</div>
                       <div className="text-[10px] text-gray-400">Querying Postgres SQL via external API for Q2 metrics.</div>
                    </div>
                    <div className={`p-3 rounded-xl border transition-all duration-500 ${step >= 2 ? 'bg-purple-500/10 border-purple-500/30' : 'bg-white/5 border-white/5 opacity-50'}`}>
                       <div className="text-purple-400 text-xs font-bold mb-1 flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${step === 2 ? 'bg-purple-400 animate-pulse shadow-[0_0_8px_purple]' : 'bg-purple-400/50'}`} /> Drafting Agent</div>
                       <div className="text-[10px] text-gray-400">Synthesizing data into email format using CRM context.</div>
                    </div>
                    <div className={`p-3 rounded-xl border transition-all duration-500 ${step >= 3 ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-white/5 border-white/5 opacity-50'}`}>
                       <div className="text-emerald-400 text-xs font-bold mb-1 flex items-center gap-2"><div className={`w-2 h-2 rounded-full ${step === 3 ? 'bg-emerald-400 animate-pulse shadow-[0_0_8px_#10b981]' : 'bg-emerald-400/50'}`} /> Reviewer Agent</div>
                       <div className="text-[10px] text-gray-400">Task Complete. Draft ready for human approval.</div>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="bg-[#040e0e] border border-white/5 rounded-3xl p-5 md:p-6 relative overflow-hidden group shadow-xl flex flex-col hover:bg-[#061414] hover:border-[#14b8a6]/30 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(20,184,166,0.15)] transition-all duration-500">
          <div className="w-12 h-12 rounded-full bg-[#14b8a6]/10 flex items-center justify-center mb-3 border border-[#14b8a6]/20 group-hover:scale-110 transition-transform">
            <Database className="w-5 h-5 text-[#14b8a6]" />
          </div>
          <h3 className="text-white font-bold text-lg mb-2">Tool & API Integration</h3>
          <p className="text-gray-400 text-xs">Agents can autonomously read databases, trigger webhooks, and push code.</p>
          
          <div className="mt-4 flex-1 border border-white/10 rounded-xl bg-[#010606] p-3 flex items-center justify-center overflow-hidden relative">
            <motion.div animate={{ x: [-30, 30, -30] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }} className="flex gap-4">
               <div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center"><Code className="w-5 h-5 text-gray-500" /></div>
               <div className="w-12 h-12 bg-[#14b8a6]/20 border border-[#14b8a6]/40 rounded-lg flex items-center justify-center"><Network className="w-6 h-6 text-[#2dd4bf]" /></div>
               <div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center"><Database className="w-5 h-5 text-gray-500" /></div>
            </motion.div>
          </div>
        </div>

        {/* Feature 2: Self Correction */}
        <div className="bg-[#040e0e] border border-white/5 rounded-3xl p-5 md:p-6 relative overflow-hidden group shadow-xl flex flex-col hover:bg-[#061414] hover:border-yellow-500/30 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(234,179,8,0.15)] transition-all duration-500">
          ...
          <h3 className="text-white font-bold text-lg mb-2">Self-Correction</h3>
          <p className="text-gray-400 text-xs">Agents verify their outputs and autonomously rewrite queries if they hit an error.</p>
          
          <div className="mt-4 flex-1 border border-white/10 rounded-xl bg-[#010606] flex items-center justify-center relative overflow-hidden py-4">
             <motion.div animate={{ rotate: 360 }} transition={{ duration: 8, repeat: Infinity, ease: "linear" }} className="w-24 h-24 border-2 border-dashed border-yellow-500/30 rounded-full flex items-center justify-center">
        ...
        <div className="lg:col-span-2 bg-[#040e0e] border border-white/5 rounded-3xl p-5 md:px-8 md:py-6 relative overflow-hidden group shadow-xl flex flex-col md:flex-row items-center gap-6 hover:bg-[#061414] hover:border-emerald-500/30 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(16,185,129,0.15)] transition-all duration-500">
          <div className="flex-1">
            <div className="w-12 h-12 rounded-full bg-emerald-500/10 flex items-center justify-center mb-3 border border-emerald-500/20 group-hover:scale-110 transition-transform">
              <UserCheck className="w-5 h-5 text-emerald-500" />
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Human-in-the-Loop Integration</h3>
            <p className="text-gray-400 text-xs md:text-sm max-w-sm">Maintain full control. Configure agents to pause execution at critical steps, requiring human approval before executing sensitive API calls.</p>
          </div>
          
          <div className="w-full md:w-auto flex-1 border border-white/10 rounded-xl bg-[#010606] p-4 flex flex-col gap-3 shadow-inner">
             <div className="text-xs font-mono text-gray-500 mb-2 flex items-center gap-2">
               <div className="w-2 h-2 rounded-full bg-yellow-500 animate-pulse" /> AWAITING_APPROVAL
             </div>
             <div className="text-sm text-gray-300 bg-white/5 p-4 rounded-lg border border-white/5 shadow-inner">
               Ready to execute: <br/><span className="text-emerald-400 font-mono text-xs mt-1 block">POST /api/v1/refunds</span>
             </div>
             <div className="flex gap-3">
               <button className="flex-1 py-2 rounded-lg bg-emerald-500/20 text-emerald-400 text-sm font-bold border border-emerald-500/30 hover:bg-emerald-500/30 transition-colors">APPROVE</button>
               <button className="flex-1 py-2 rounded-lg bg-red-500/20 text-red-400 text-sm font-bold border border-red-500/30 hover:bg-red-500/30 transition-colors">REJECT</button>
             </div>
          </div>
        </div>
