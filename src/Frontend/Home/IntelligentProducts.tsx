...
export function IntelligentProducts() {
  return (
    <section id="products" className="py-8 md:py-12 relative bg-[#050505] overflow-hidden border-t border-white/[0.02]">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-7 md:mb-10">
          <div className="inline-flex items-center gap-2 px-2.5 py-1 glass-pill mb-3 md:mb-4 border-glow">
          ...
          <h2 className="text-2xl md:text-4xl font-bold tracking-tight leading-tight mb-2 md:mb-3 pb-2" style={{ fontFamily: fonts.display }}>
            Intelligent <span className="text-white/40">Products.</span>
          </h2>
          
          <p className="text-white/50 text-[12px] md:text-[13px] leading-[1.6] font-light max-w-lg mx-auto" style={{ fontFamily: fonts.body }}>
            Purpose-built platforms integrating seamlessly into operations, bringing autonomous capabilities to every department.
          </p>
        </div>

        {/* Bento Box Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-6 w-full mx-auto mb-7 md:mb-10">
          
          {/* Main Large Card (Left) */}
          <div className="lg:col-span-3 group relative rounded-[24px] overflow-hidden bg-[#0A0B0F] border border-white/[0.08] hover:border-white/[0.2] transition-colors duration-500 min-h-[260px] md:min-h-[300px] flex flex-col p-5 md:p-8">
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="mt-5 md:mt-8">
                <span 
                  className="inline-block px-2.5 py-1 rounded-full border border-white/[0.1] text-[8px] uppercase tracking-widest font-mono mb-3 md:mb-4 bg-black/40 backdrop-blur-md"
                  style={{ color: overviewProducts[0].color }}
                >
                  Key Feature: {overviewProducts[0].metric}
                </span>
                
                <h3 className="text-xl md:text-3xl font-bold text-white tracking-tight mb-2 md:mb-3 leading-tight" style={{ fontFamily: fonts.display }}>
                  {overviewProducts[0].title}
                </h3>
                
                <p className="text-[12px] md:text-[14px] text-white/50 leading-[1.6] font-light max-w-md mb-4 md:mb-6" style={{ fontFamily: fonts.body }}>
          ...
          <div className="lg:col-span-2 grid grid-cols-2 lg:grid-cols-1 lg:flex lg:flex-col gap-4">
            
            {/* Secondary Card (Top) */}
            <div className="group relative rounded-[24px] overflow-hidden bg-[#0A0B0F] border border-white/[0.08] hover:border-white/[0.2] transition-colors duration-500 flex-1 flex flex-col p-3.5 md:p-5">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <div>
                  <h3 className="text-sm md:text-lg font-bold text-white tracking-tight mb-1 md:mb-1.5" style={{ fontFamily: fonts.display }}>
                    {overviewProducts[1].title}
                  </h3>
                  <p className="text-[11px] md:text-[12px] text-white/50 leading-[1.5] font-light mb-2 md:mb-3 line-clamp-2" style={{ fontFamily: fonts.body }}>
        ...
        {/* Bottom CTA */}
        <div className="flex justify-center mt-5 md:mt-8 relative">
          <Link href="/services">
            <button 
              className="group relative flex items-center gap-2 md:gap-3 px-6 py-3 md:px-8 md:py-3.5 bg-transparent rounded-full transition-all duration-500 overflow-hidden border border-white/10 hover:border-white/30 hover:scale-[1.02]"
            >
              {/* Background states */}
